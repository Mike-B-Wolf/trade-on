...
const cards = [
  { image: "/cars-card.webp", icon: "/icon-cars.png" },
  { image: "/seafood-card.webp", icon: "/icon-seafood.png" },
  { image: "/farm-card.webp", icon: "/icon-farm.png" },
  { image: "/matcha-card.webp", icon: "/icon-matcha.png" },
  { image: "/watch-card.webp", icon: "/icon-watch.png" },
  { image: "/other-card.webp", icon: "/icon-global.png" },
];
        ...
        <div className="relative grid items-start gap-5 lg:grid-cols-[1fr_1.9fr] lg:items-center lg:gap-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              <h3 className="text-2xl font-black leading-snug text-white">
                {dict.other.titleLines.map((line, index) => (
                  <span key={line}>
                    {index > 0 && <br />}
                    {line}
                  </span>
          ...
          <div className="max-w-3xl border-l border-white/10 pl-8">
            <p className="text-lg leading-5.5 text-white/85">
              {dict.other.bodyLines.map((line, index) => (
                <span key={line}>
                  {index > 0 && <br />}
                  {line}
                </span>
